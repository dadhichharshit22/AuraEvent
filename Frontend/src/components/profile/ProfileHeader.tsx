...
const ProfileHeader: React.FC<ProfileHeaderProps> = ({ name, username, role, avatarSrc }) => {
  return (
    <CardHeader className="bg-purple-100 text-center p-6 rounded-t-lg">
      <Avatar className="h-32 w-32 mx-auto mb-4 border-4 border-white shadow-lg">
        ...
        <AvatarFallback className="bg-purple-300 text-4xl">{name.charAt(0)}</AvatarFallback>
      </Avatar>
      <CardTitle className="text-3xl font-bold text-purple-800">{name}</CardTitle>
