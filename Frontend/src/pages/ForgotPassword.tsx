  ...
  return (
    <div className="flex gap-2 justify-between h-screen text-black">
      ...
      <div className="w-1/2 h-full">
        <img src={ilus} alt="Event Illustration" className="w-full h-full object-cover rounded-r-3xl" />
      </div>
        ...
        <div className="w-1/2 space-y-4">
          ...
          {otpSent && (
            <div className="space-y-4">
              ...
              <p className="text-sm text-red-500 text-center">OTP will expire in 2 minutes</p>
            </div>
          )}
        </div>
      </div>
